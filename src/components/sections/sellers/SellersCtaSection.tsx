        ...
        <AnimateOnView animation="stagger" rootMargin="0px 0px -80px 0px">
          <div className="relative overflow-hidden rounded-xl px-4 py-12 text-center sm:rounded-2xl sm:px-6 sm:py-14 md:rounded-[20px] md:px-12 md:py-20 lg:px-16 lg:py-24">
            ...
            <div
              ...
              style={{
                background: `linear-gradient(${PRIMARY} 0%, rgba(34, 197, 94, 0.4) 100%)`,
              }}
            />
            <div
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="stagger-child mt-2 flex flex-row flex-wrap items-center justify-center gap-2 sm:gap-4">
                <Link
                  ...
                  className="rounded-full border-2 border-green-400/50 bg-white px-[20px] py-[10px] text-[16px] font-medium text-zinc-900 shadow-[inset_0_4px_14px_white] transition-colors hover:bg-zinc-100 md:px-[30px] md:py-[20px] md:text-[18px]"
                >
                  {cta.primary.label}
                </Link>
                <Link
                  href={cta.secondary.href}
                  className="rounded-full border-2 border-white/50 bg-transparent px-[20px] py-[10px] text-[16px] font-medium text-white transition-colors hover:bg-white/10 md:px-[30px] md:py-[20px] md:text-[18px]"
                >
                  {cta.secondary.label}
                </Link>
              </div>
